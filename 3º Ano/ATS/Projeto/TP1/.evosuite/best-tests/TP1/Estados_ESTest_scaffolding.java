...
public class Estados_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "TP1.Estados"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Estados_ESTest_scaffolding.class.getClassLoader() ,
      "TP1.TShirt$Padrao",
      "TP1.Sapatilhas",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(Estados_ESTest_scaffolding.class.getClassLoader()); 
