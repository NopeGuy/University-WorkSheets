...
public class Artigo_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "TP1.Artigo"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Artigo_ESTest_scaffolding.class.getClassLoader() ,
      "TP1.TShirt$Padrao",
      "TP1.Sapatilhas",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(Artigo_ESTest_scaffolding.class.getClassLoader()); 
