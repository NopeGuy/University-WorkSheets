...
public class Aluno {
    ...
    public Aluno(String nome, String numero, Map<String, Double> notas) throws NotaInvalidaException {
        if (nome == null || nome.isEmpty()) {
            throw new NotaInvalidaException("Nome inválido");
        }
        if (numero == null || numero.isEmpty()) {
            throw new NotaInvalidaException("Número inválido");
        }
        if (notas == null) {
            throw new NotaInvalidaException("Notas inválidas");
        }
